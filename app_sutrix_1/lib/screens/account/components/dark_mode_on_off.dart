...
class DarkModeOnOff extends StatelessWidget {
  final bool darkMode;
...
class ButtonOnOff extends StatefulWidget {
  ...
  const ButtonOnOff({Key key, this.darkMode}) : super(key: key);
  @override
